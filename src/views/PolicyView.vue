  ...
  <layout-default>
    <div class="text">
      <div class="text__container container">
        <h3>Polityka prywatności serwisu https://polandgroups.pl/shop/</h3>

        <h3>1. Informacje ogólne</h3>

        <p>1. Operatorem Serwisu https://polandgroups.pl/shop/ jest Polandgroups Spółka z ograniczoną odpowiedzialnością z siedzibą w Warszawie, ul. Aleja Krakowska 121 02-180 Warszawa, wpisaną w Rejestrze Przedsiębiorców Krajowego Rejestru Sądowego prowadzonym przez Sąd Rejonowy KRS 0000618480,  posiadającą numer identyfikacji podatkowej NIP 1132910509 oraz Regon 364474954, który prowadząc działalność gospodarczą dokonuje w ramach Sklepu sprzedaży towarów lub świadczenia usług.</p>
        ...
        <p>a. tworzenia statystyk, które pomagają zrozumieć, w jaki sposób Użytkownicy Serwisu korzystają ze stron internetowych, co umożliwia ulepszanie ich struktury i zawartości;</p>

        <p>b. utrzymanie sesji Użytkownika Serwisu (po zalogowaniu), dzięki której Użytkownik nie musi na każdej podstronie Serwisu ponownie wpisywać loginu i hasła;</p>

        <p>c. określania profilu użytkownika w celu wyświetlania mu dopasowanych materiałów w sieciach reklamowych, w szczególności sieci Google.</p>
        ...
        <p>1. Informacje o niektórych zachowaniach użytkowników podlegają logowaniu w warstwie serwerowej. Dane te są wykorzystywane wyłącznie w celu administrowania serwisem oraz w celu zapewnienia jak najbardziej sprawnej obsługi świadczonych usług hostingowych.</p>

        <p>2. Przeglądane zasoby identyfikowane są poprzez adresy URL. Ponadto zapisowi mogą podlegać:</p>

        <p>a. Czas nadejścia zapytania,</p>

        <p>b. Czas wysłania odpowiedzi,</p>

        <p>c. Nazwę stacji klienta – identyfikacja realizowana przez protokół HTTP,</p>

        <p>d. Informacje o błędach jakie nastąpiły przy realizacji transakcji HTTP,</p>

        <p>e. Adres URL strony poprzednio odwiedzanej przez użytkownika (referer link) – w przypadku gdy przejście do Serwisu nastąpiło przez odnośnik,</p>

        <p>f. Informacje o przeglądarce użytkownika,</p>

        <p>g.Informacje o adresie IP.</p>
